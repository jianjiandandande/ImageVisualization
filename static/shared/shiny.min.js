...
!function () {
    ...
    function getStyle(a, b) {
        var c;
        if (a.currentStyle) c = a.currentStyle[b]; else if (window.getComputedStyle) {
    ...
    function makeResizeFilter(a, b) {
        var c = {};
        return function () {
            var d = {w: a.offsetWidth, h: a.offsetHeight};
    ...
    function mergeSort(a, b) {
        ...
        a = a.slice(0);
        for (var d = 1; d < a.length; d *= 2) for (var e = 0; e < a.length; e += 2 * d) {
            var f = a.slice(e, e + d), g = a.slice(e + d, e + 2 * d), h = c(b, f, g), i = [e, h.length];
    ...
    function _equal(a, b) {
        if ("object" === $.type(a) && "object" === $.type(b)) {
            ...
            for (var c in a) if (!b.hasOwnProperty(c) || !_equal(a[c], b[c])) return !1;
            return !0
        }
        if ("array" === $.type(a) && "array" === $.type(b)) {
            if (a.length !== b.length) return !1;
            for (var d = 0; d < a.length; d++) if (!_equal(a[d], b[d])) return !1;
            return !0
        }
        return a === b
    }
    ...
    function equal() {
        ...
        for (var d = 0; d < b.length - 1; d++) if (!_equal(b[d], b[d + 1])) return !1;
        return !0
    }
    ...
    function multimethod() {
        ...
        function b(b) {
            return function () {
                ...
                g = !0;
                for (var f = b.apply(h, d); f instanceof a;) f = b.apply(h, f.args);
                return g = !1, f
            }
        }

        var c = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function (a) {
                return a
            }, d = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : equal,
            e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
            f = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [], g = !1, h = b(function () {
                for (var a = arguments.length, b = Array(a), g = 0; g < a; g++) b[g] = arguments[g];
                for (var i = c.apply(null, b), j = 0; j < f.length; j++) {
                    var k = _slicedToArray(f[j], 2), l = k[0], m = k[1];
                    if (d(i, l)) return m.apply(h, b)
                }
                if (e) return e.apply(h, b);
                throw new Error("No method for dispatch value " + i)
            });
        return h.recur = function () {
            for (var b = arguments.length, c = Array(b), d = 0; d < b; d++) c[d] = arguments[d];
            if (!g) throw new Error("recur can only be called inside a method");
            return new a(c)
            ...
            return f = f.concat([[a, b]]), h
        }, h.whenAny = function (a, b) {
            ...
            return multimethod(c, d, e, f.slice())
        }, h
    }
    ...
    function addDefaultInputOpts(a) {
        return $.extend({immediate: !1, binding: null, el: null}, a)
    }

    function splitInputNameType(a) {
        var b = a.split(":");
        return {name: b[0], inputType: b.length > 1 ? b[1] : ""}
    }
    ...
    function uploadFiles(a) {
        ...
        var c = a.target.files, d = "undefined" == typeof c, e = fileInputBinding.getId(a.target);
        if (d || 0 !== c.length) {
    ...
    function initShiny() {
        function a() {
            ...
            a = $(a);
            for (var b = outputBindings.getBindings(), c = 0; c < b.length; c++) for (var d = b[c].binding, e = d.find(a) || [], f = 0; f < e.length; f++) {
                var g = e[f], h = d.getId(g);
        ...
        function b() {
            ...
            for (var d = 0; d < c.length; d++) {
                var e = $(c[d]), f = e.data("shiny-output-binding");
                if (f) {
        ...
        function c(a, b, c) {
            var d = a.getId(b);
            if (d) {
                var e = a.getValue(b), f = a.getType(b);
                f && (d = d + ":" + f);
                var g = {immediate: !c, binding: a, el: b};
                p.setInput(d, e, g)
            }
        }

        function d() {
            for (var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document, b = inputBindings.getBindings(), d = {}, e = 0; e < b.length; e++) for (var f = b[e].binding, g = f.find(a) || [], h = 0; h < g.length; h++) {
                var i = g[h], j = f.getId(i);
                if (j && !w[j]) {
                    var k = f.getType(i), l = k ? j + ":" + k : j;
                    d[l] = {value: f.getValue(i), opts: {immediate: !0, binding: f, el: i}};
                    var m = function () {
                        var a = f, b = i;
                        return function (d) {
                            c(a, b, d)
                    ...
                    null !== n && u.setRatePolicy(l, n.policy, n.delay), w[j] = {
                        binding: f,
                        node: i
                    }, $(i).trigger({type: "shiny:bound", binding: f, bindingType: "input"})
                }
            }
            return d
        }
        ...
        function e() {
            ...
            for (var d = 0; d < c.length; d++) {
                var e = c[d], f = $(e).data("shiny-input-binding");
                if (f) {
                    var g = f.getId(e);
        ...
        function h() {
            for (var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document, b = inputBindings.getBindings(), c = 0; c < b.length; c++) for (var d = b[c].binding, e = d.find(a) || [], f = 0; f < e.length; f++) e[f]._shiny_initialized || (e[f]._shiny_initialized = !0, d.initialize(e[f]))
        }

        function i(a) {
            var b = $(a), c = b.data("shiny-output-binding");
        ...
        function j() {
            $(".shiny-image-output, .shiny-plot-output").each(function () {
                ...
                var a = $(this), b = a.data("shiny-output-binding");
                a.trigger({type: "shiny:visualchange", visible: !l(this), binding: b}), b.onResize()
            })
        }
        ...
        function m() {
            ...
            $(".shiny-bound-output").each(function () {
                var b = i(this);
                delete z[b];
                var c = l(this), d = {type: "shiny:visualchange", visible: !c};
        ...
        function o(a, b) {
            return a = a.split("."), function (c) {
                for (var d = c.namespace.split("."), e = 0; e < a.length; e++) if (d.indexOf(a[e]) === -1) return;
                b.apply(this, arguments)
            }
        }

        var p, q = exports.shinyapp = new ShinyApp, r = new InputBatchSender(q), s = new InputNoResendDecorator(r),
            t = new InputEventDecorator(s), u = new InputRateDecorator(t), v = new InputDeferDecorator(t);
        ...
        })) : p = u, p = new InputValidateDecorator(p), exports.onInputChange = function (a, b, c) {
        ...
        $.each(B, function (a, b) {
            $("body").on("shown.bs." + b + ".sendImageSize", "*", o("bs", k)), $("body").on("shown.bs." + b + ".sendOutputHiddenState hidden.bs." + b + ".sendOutputHiddenState", "*", o("bs", n))
        }), $("body").on("shown.sendImageSize", "*", k), $("body").on("shown.sendOutputHiddenState hidden.sendOutputHiddenState", "*", n), x[".clientdata_pixelratio"] = pixelRatio(), $(window).resize(function () {
            ...
            p.setInput(".clientdata_url_hash", location.hash)
        });
    ...
    var $ = jQuery, exports = window.Shiny = window.Shiny || {}, origPushState = window.history.pushState;
    ...
    var _BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder,
        $escape = exports.$escape = function (a) {
            ...
            function a() {
                var a = -1;
                if (c) {
                    var b = navigator.userAgent, d = new RegExp("MSIE ([0-9]{1,}[\\.0-9]{0,})");
            ...
            return {isQt: b, isIE: c, IEVersion: a()}
    ...
    (function () {
        this.setInput = function (a, b) {
            var c = this;
            this.pendingData[a] = b, this.timerId || this.reentrant || (this.timerId = setTimeout(function () {
                c.reentrant = !0;
                try {
                    $.each(c.lastChanceCallback, function (a, b) {
                        b()
                    }), c.timerId = null;
                    var a = c.pendingData;
                    c.pendingData = {}, c.shinyapp.sendInput(a)
                } finally {
                    c.reentrant = !1
                }
            }, 0))
    ...
    (function () {
        this.setInput = function (a, b) {
            var c = splitInputNameType(a), d = c.name, e = c.inputType, f = JSON.stringify(b);
            this.lastSentValues[d] && this.lastSentValues[d].jsonValue === f && this.lastSentValues[d].inputType === e || (this.lastSentValues[d] = {
                jsonValue: f,
                inputType: e
            }, this.target.setInput(a, b))
        }, this.reset = function () {
            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = {};
            for (var c in a) if (a.hasOwnProperty(c)) {
                var d = splitInputNameType(c), e = d.name, f = d.inputType;
                b[e] = {jsonValue: JSON.stringify(a[c]), inputType: f}
            }
    ...
    (function () {
        this.setInput = function (a, b, c) {
            var d = jQuery.Event("shiny:inputchanged"), e = splitInputNameType(a);
            d.name = e.name, d.inputType = e.inputType, d.value = b, d.binding = c.binding, d.el = c.el, $(document).trigger(d), d.isDefaultPrevented() || (a = d.name, "" !== d.inputType && (a += ":" + d.inputType), this.target.setInput(a, d.value))
        }
    ...
    (function () {
        this.setInput = function (a, b, c) {
            this.$ensureInit(a), c.immediate ? this.inputRatePolicies[a].immediateCall(a, b, c) : this.inputRatePolicies[a].normalCall(a, b, c)
        }, this.setRatePolicy = function (a, b, c) {
            "direct" === b ? this.inputRatePolicies[a] = new Invoker(this, this.$doSetInput) : "debounce" === b ? this.inputRatePolicies[a] = new Debouncer(this, this.$doSetInput, c) : "throttle" === b && (this.inputRatePolicies[a] = new Throttler(this, this.$doSetInput, c))
    ...
    (function () {
        this.setInput = function (a, b, c) {
            /^\./.test(a) ? this.target.setInput(a, b, c) : this.pendingInput[a] = {value: b, opts: c}
        }, this.submit = function () {
            for (var a in this.pendingInput) if (this.pendingInput.hasOwnProperty(a)) {
                var b = this.pendingInput[a];
                this.target.setInput(a, b.value, b.opts)
            }
        }
    ...
    (function () {
        ...
        function narrowScope(a, b) {
            return b ? {input: narrowScopeComponent(a.input, b), output: narrowScopeComponent(a.output, b)} : a
        }
        ...
        function getTabContent(a) {
            var b = a.attr("data-tabsetid"), c = $("div.tab-content[data-tabsetid='" + $escape(b) + "']");
            return c
        }

        function getTargetTabs(a, b, c) {
            var d = "[data-value='" + $escape(c) + "']", e = a.find("a" + d), f = e.parent();
            if (0 === f.length) throw"There is no tabPanel (or navbarMenu) with value (or menuName) equal to '" + c + "'";
            var g = [], h = [];
            if ("dropdown" === e.attr("data-toggle")) {
                var i = e.find("+ ul.dropdown-menu"), j = i.attr("data-tabsetid"),
                    k = i.find("a[data-toggle='tab']").parent("li");
                k.each(function (a, b) {
                    g.push($(b))
                });
                var l = "div.tab-pane[id^='tab-" + $escape(j) + "']", m = b.find(l);
                m.each(function (a, b) {
                    h.push($(b))
                })
            } else h.push(b.find("div" + d));
            return {$liTag: f, $liTags: g, $divTags: h}
        }

        function ensureTabsetHasVisibleTab(a) {
            if (0 === a.find("li.active").not(".dropdown").length) {
                var b = getFirstTab(a), c = a.data("shiny-input-binding"), d = jQuery.Event("shiny:updateinput");
        ...
        this.reconnect = function () {
            ...
            var a = this, b = exports.createSocket || function () {
                var a = "ws:";
            ...
            var b = JSON.stringify({method: "update", data: a});
            ...
            }, b = parent !== window ? document.referrer : null;
            if (b) {
                var c = document.createElement("a");
                if (c.href = b, a(c.hostname) === a(window.location.hostname)) {
                    var d = c.protocol.replace(":", ""), e = d + "://" + c.hostname;
                    c.port && (e = e + ":" + c.port), parent.postMessage("disconnected", e)
                }
            }
        ...
        var reconnectDelay = function () {
            var a = 0, b = [1500, 1500, 2500, 2500, 5500, 5500, 10500];
            return {
                next: function () {
                    var c = a;
        ...
        this.onDisconnected = function () {
            ...
            this.$nextRequestId = f + 1, this.$activeRequests[f] = {onSuccess: c, onError: d};
            var g = JSON.stringify({method: a, args: b, tag: f});
            if (e) {
                var h = function (a) {
                    var b = new ArrayBuffer(4), c = new DataView(b);
            ...
            if (this.$errors[a] !== b) {
                ...
                var c = this.$bindings[a], d = jQuery.Event("shiny:error");
            ...
            if (this.$values[a] !== b) {
                this.$values[a] = b, delete this.$errors[a];
                var c = this.$bindings[a], d = jQuery.Event("shiny:value");
                return d.name = a, d.value = b, d.binding = c, $(c ? c.el : document).trigger(d), !d.isDefaultPrevented() && c && c.onValueChange(d.value), b
            }
            ...
            $(document).trigger({type: "shiny:conditional"});
            var a = {};
            for (var b in this.$inputValues) if (this.$inputValues.hasOwnProperty(b)) {
                var c = b.replace(/:.*/, "");
        ...
        exports.addCustomMessageHandler = addCustomMessageHandler, this.dispatchMessage = function (a) {
            ...
            for (var b = 0; b < a.length; b++) {
                var c = $(".shiny-bound-input#" + $escape(a[b].id)), d = c.data("shiny-input-binding");
                if (c.length > 0) {
                    var e = c[0], f = jQuery.Event("shiny:updateinput");
            ...
            if ("show" === a.type) exports.notifications.show(a.message); else {
            ...
            if (a.hasOwnProperty("name") && a.hasOwnProperty("status")) {
                ...
                $(b ? b.el : null).trigger({type: "shiny:" + a.status})
            }
            ...
            var b = $(a.selector);
            b.each(function (b, c) {
                return exports.unbindAll(c, !0), $(c).remove(), a.multiple
            })
            ...
            function c() {
                if (null !== a.menuName) {
                    ...
                    var c = b.find("+ ul.dropdown-menu"), d = c.attr("data-tabsetid");
                    return {$tabset: c, id: d}
                }
                if (null !== a.target) {
                    var e = l.parent("ul");
                    if (e.hasClass("dropdown-menu")) {
                        var f = e.attr("data-tabsetid");
                        return {$tabset: e, id: f}
                    }
                }
                return null
            }

            var d = getTabset(a.inputId), e = d, f = getTabContent(e), g = d.attr("data-tabsetid"),
                h = $(a.divTag.html), i = $(a.liTag.html), j = i.find("> a"), k = null, l = null;
            ...
            var c = getTabset(a.inputId), d = getTabContent(c), e = getTargetTabs(c, d, a.target);
            ...
            var b = null;
            if ("#" === a.queryString.charAt(0)) b = "hash"; else {
            ...
            var c = window.location.pathname, d = window.location.search, e = window.location.hash, f = c;
        ...
        var progressHandlers = {
            binding: function a(b) {
                ...
                if ("notification" === a.style) exports.notifications.show({
                    ...
                    0 === b.length && (b = $('<div class="shiny-progress-container"></div>'), $("body").append(b));
                ...
                if ("notification" === a.style) exports.notifications.remove(a.id); else if ("old" === a.style) {
                    var b = $("#" + a.id + ".shiny-progress");
        ...
        exports.progressHandlers = progressHandlers, this.getTestSnapshotBaseUrl = function () {
            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = a.fullUrl,
                c = void 0 === b || b, d = window.location, e = "";
        ...
        function a() {
            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = a.html,
                d = void 0 === b ? "" : b, e = a.action, j = void 0 === e ? "" : e, k = a.deps,
                l = void 0 === k ? [] : k, m = a.duration, n = void 0 === m ? 5e3 : m, o = a.id,
                p = void 0 === o ? null : o, q = a.closeButton, r = void 0 === q || q, s = a.type,
                t = void 0 === s ? null : s;
            p || (p = randomId()), f();
            var u = c(p);
            0 === u.length && (u = g(p));
            ...
            exports.renderContent(w, {html: v, deps: l});
        ...
        function f() {
            var a = e();
            return a.length > 0 ? a : ($("body").append('<div id="shiny-notification-panel">'), a)
        }
        ...
        function i(a) {
            var b = c(a), d = b.data("removalCallback");
            d && clearTimeout(d)
        }

        var j = 250;
        return {show: a, remove: b}
    }(), exports.modal = {
        show: function () {
            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = a.html,
                c = void 0 === b ? "" : b, d = a.deps, e = void 0 === d ? [] : d;
            $(".modal-backdrop").remove();
            var f = $("#shiny-modal-wrapper");
            0 === f.length && (f = $('<div id="shiny-modal-wrapper"></div>'), $("body").append(f), f.on("hidden.bs.modal", function (a) {
            ...
            }), exports.renderContent(f, {html: c, deps: e})
        }, remove: function () {
    ...
    $.extend(imageOutputBinding, {
        find: function (a) {
            ...
            $.each(b, function (a, b) {
                null !== b && "coordmap" !== a && d.setAttribute(a, b)
            });
            for (var i = 0; i < d.attributes.length; i++) {
                var j = d.attributes[i];
                j.specified && !b.hasOwnProperty(j.name) && d.removeAttribute(j.name)
            }
            h.coordmap || (h.coordmap = []), imageutils.initCoordmap(f, h.coordmap);
            var k = imageutils.createClickInfo(f, h.dblclickId, h.dblclickDelay);
            if (f.on("mousedown.image_output", k.mousedown), browser.isIE && 8 === browser.IEVersion && f.on("dblclick.image_output", k.dblclickIE8), h.clickId) {
                var l = imageutils.createClickHandler(h.clickId, h.clickClip, h.coordmap);
                f.on("mousedown2.image_output", l.mousedown), g.on("reset", l.onResetImg)
            }
            if (h.dblclickId) {
                var m = imageutils.createClickHandler(h.dblclickId, h.clickClip, h.coordmap);
                f.on("dblclick2.image_output", m.mousedown), g.on("reset", m.onResetImg)
            }
            if (h.hoverId) {
                var n = imageutils.createHoverHandler(h.hoverId, h.hoverDelay, h.hoverDelayType, h.hoverClip, h.hoverNullOutside, h.coordmap);
                f.on("mousemove.image_output", n.mousemove), f.on("mouseout.image_output", n.mouseout), g.on("reset", n.onResetImg)
            }
            if (h.brushId) {
                g.css("-webkit-user-drag", "none"), g.on("dragstart", function () {
                    return !1
                }), f.on("selectstart.image_output", function () {
                    return !1
                });
                var o = imageutils.createBrushHandler(h.brushId, f, h, h.coordmap, e);
                f.on("mousedown.image_output", o.mousedown), f.on("mousemove.image_output", o.mousemove), g.on("reset", o.onResetImg)
            }
    ...
    imageutils.initPanelScales = function (a) {
        function b(a, b, c, d, e, f) {
            f = f || !0;
            var g = (e - d) / (c - b), h = a - b, i = h * g + d;
            if (f) {
                var j = Math.max(e, d), k = Math.min(e, d);
                i > j ? i = j : i < k && (i = k)
            }
            return i
        }
        ...
        function d(a) {
            var b = a.domain, d = a.range, e = a.log && a.log.x ? a.log.x : null, f = a.log && a.log.y ? a.log.y : null,
                g = c(b.left, b.right, d.left, d.right, e), h = c(b.bottom, b.top, d.bottom, d.top, f);
            a.scale = function (a, b) {
                return {x: g.scale(a.x, b), y: h.scale(a.y, b)}
            }, a.scaleInv = function (a, b) {
                return {x: g.scaleInv(a.x, b), y: h.scaleInv(a.y, b)}
            }, a.clip = function (b) {
                var c = {x: b.x, y: b.y}, d = a.range;
        ...
        var c = a[0];
        if (0 === b.length) {
            var d = {top: 0, left: 0, right: c.clientWidth - 1, bottom: c.clientHeight - 1};
            b[0] = {domain: d, range: d, mapping: {}}
        }
        imageutils.initPanelScales(b), b.mouseOffset = function (b) {
            var c = a.offset();
            return {x: b.pageX - c.left, y: b.pageY - c.top}
        }, b.findBox = function (a, b) {
            return {
        ...
        }, b.shiftToRange = function (a, b, c) {
            a instanceof Array || (a = [a]);
            var d = Math.max.apply(null, a), e = Math.min.apply(null, a), f = 0;
            d > c ? f = c - d : e < b && (f = b - e);
            for (var g = [], h = 0; h < a.length; h++) g[h] = a[h] + f;
            return g
        }, b.getPanel = function (a, c) {
            c = c || 0;
            for (var d, e = a.x, f = a.y, g = [], h = [], i = 0; i < b.length; i++) if (d = b[i].range, e <= d.right + c && e >= d.left - c && f <= d.bottom + c && f >= d.top - c) {
                g.push(b[i]);
                var j = 0, k = 0;
                e > d.right && e <= d.right + c ? j = e - d.right : e < d.left && e >= d.left - c && (j = e - d.left), f > d.bottom && f <= d.bottom + c ? k = f - d.bottom : f < d.top && f >= d.top - c && (k = f - d.top), h.push(Math.sqrt(Math.pow(j, 2) + Math.pow(k, 2)))
            }
            if (g.length) {
                var l = Math.min.apply(null, h);
                for (i = 0; i < g.length; i++) if (h[i] === l) return g[i]
            }
            return null
        }, b.isInPanel = function (a, c) {
            return c = c || 0, !!b.getPanel(a, c)
        }, b.mouseCoordinateSender = function (a, c, d) {
            return void 0 === c && (c = !0), void 0 === d && (d = !1), function (e) {
                if (null === e) return void exports.onInputChange(a, null);
                var f = b.mouseOffset(e);
                if (!b.isInPanel(f)) {
                    if (d) return void exports.onInputChange(a, null);
                    if (c) return
                }
                if (!c || b.isInPanel(f)) {
                    var g = b.getPanel(f), h = g.scaleInv(f);
                    $.extend(h, g.panel_vars), h.mapping = g.mapping, h.domain = g.domain, h.range = g.range, h.log = g.log, h[".nonce"] = Math.random(), exports.onInputChange(a, h)
                }
            }
        }
        ...
        function g(a) {
            if (1 === a.which) return b ? void(null === j ? f(a) : (clearTimeout(i), j && Math.abs(j.offsetX - a.offsetX) > 2 || Math.abs(j.offsetY - a.offsetY) > 2 ? (e(), f(a)) : (j = null, d("dblclick2", a)))) : void d("mousedown2", a)
        }
        ...
        var i = null, j = null;
        return {mousedown: g, dblclickIE8: h}
        ...
        return i = e ? function () {
            ...
            mousemove: function (a) {
                g.normalCall(a)
            }, mouseout: i, onResetImg: function () {
        ...
        function g() {
            var d = r.boundsData();
            if (isNaN(d.xmin)) return exports.onInputChange(a, null), void imageOutputBinding.find(document).trigger("shiny-internal:brushed", {
                brushId: a,
                outputId: null
            });
            var f = r.getPanel();
            $.extend(d, f.panel_vars), d.mapping = f.mapping, d.domain = f.domain, d.range = f.range, d.log = f.log, d.direction = c.brushDirection, d.brushId = a, d.outputId = e, exports.onInputChange(a, d), b.data("mostRecentBrush", !0), imageOutputBinding.find(document).trigger("shiny-internal:brushed", d)
        }

        function h(a) {
            if (!(r.isBrushing() || r.isDragging() || r.isResizing()) && 1 === a.which) {
                var b = d.mouseOffset(a);
                if (!c.brushClip || d.isInPanel(b, q)) if (r.up({
                        x: NaN,
                        y: NaN
                    }), r.down(b), r.isInResizeArea(b)) r.startResizing(b), $(document).on("mousemove.image_brush", l).on("mouseup.image_brush", o); else if (r.isInsideBrush(b)) r.startDragging(b), f("grabbing"), $(document).on("mousemove.image_brush", k).on("mouseup.image_brush", n); else {
                    var e = d.getPanel(b, q);
                    r.startBrushing(e.clip(b)), $(document).on("mousemove.image_brush", j).on("mouseup.image_brush", m)
                }
            }
        }
        ...
        function i(a) {
            var b = d.mouseOffset(a);
            if (!(r.isBrushing() || r.isDragging() || r.isResizing())) if (r.isInResizeArea(b)) {
                var c = r.whichResizeSides(b);
            ...
            } else f(r.isInsideBrush(b) ? "grabbable" : d.isInPanel(b, q) ? "crosshair" : null)
        }

        function j(a) {
            r.brushTo(d.mouseOffset(a)), s.normalCall()
        }

        function k(a) {
            r.dragTo(d.mouseOffset(a)), s.normalCall()
        }

        function l(a) {
            r.resizeTo(d.mouseOffset(a)), s.normalCall()
        }

        function m(a) {
            if (1 === a.which) return $(document).off("mousemove.image_brush").off("mouseup.image_brush"), r.up(d.mouseOffset(a)), r.stopBrushing(), f("crosshair"), r.down().x === r.up().x && r.down().y === r.up().y ? (r.reset(), void s.immediateCall()) : void(s.isPending() && s.immediateCall())
        }

        function n(a) {
            1 === a.which && ($(document).off("mousemove.image_brush").off("mouseup.image_brush"), r.up(d.mouseOffset(a)), r.stopDragging(), f("grabbable"), s.isPending() && s.immediateCall())
        }

        function o(a) {
            1 === a.which && ($(document).off("mousemove.image_brush").off("mouseup.image_brush"), r.up(d.mouseOffset(a)), r.stopResizing(), s.isPending() && s.immediateCall())
        }

        function p() {
            c.brushResetOnNew && b.data("mostRecentBrush") && (r.reset(), s.immediateCall())
        }

        var q = 20, r = imageutils.createBrush(b, c, d, q);
        b.on("shiny-internal:brushed.image_output", function (c, d) {
            d.brushId === a && d.outputId !== e && (b.data("mostRecentBrush", !1), r.reset())
        });
        var s;
        return s = "throttle" === c.brushDelayType ? new Throttler(null, g, c.brushDelay) : new Debouncer(null, g, c.brushDelay), c.brushResetOnNew || b.data("mostRecentBrush") && (r.importOldBrush(), s.immediateCall()), {
            mousedown: h,
            mousemove: i,
            onResetImg: p
        }
        ...
        function e() {
            F.brushing = !1, F.dragging = !1, F.resizing = !1, F.down = {x: NaN, y: NaN}, F.up = {
                x: NaN,
                y: NaN
            }, F.resizeSides = {left: !1, right: !1, top: !1, bottom: !1}, F.boundsPx = {
                xmin: NaN,
                xmax: NaN,
                ymin: NaN,
                ymax: NaN
                ...
                ymin: NaN,
                ymax: NaN
            }, F.panel = null, F.changeStartBounds = {xmin: NaN, xmax: NaN, ymin: NaN, ymax: NaN}, E && E.remove()
        }

        function f() {
            function b(a, b) {
                if (void 0 === a) return void 0 === b;
            ...
            var d = a.find("#" + D.id + "_brush");
            if (0 !== d.length) {
                var e = d.data("bounds-data"), f = d.data("panel");
                if (e && f) {
                    for (var g = 0; g < c.length; g++) {
                        var h = c[g];
                        if (b(f.mapping, h.mapping) && b(f.panel_vars, h.panel_vars)) {
                            F.panel = c[g];
                            break
                        }
                    }
                    if (null === F.panel) return void d.remove();
                    E = d, k(e), n()
                }
            }
        }
        ...
        function i(a) {
            var c = F.boundsPx, d = {xmin: c.xmin - C, xmax: c.xmax + C, ymin: c.ymin - C, ymax: c.ymax + C},
                e = {left: !1, right: !1, top: !1, bottom: !1};
        ...
        function j(a) {
            if (void 0 === a) return F.boundsPx;
            var d = {x: a.xmin, y: a.ymin}, e = {x: a.xmax, y: a.ymax}, f = F.panel, g = f.range;
            b.brushClip && (d = f.clip(d), e = f.clip(e)), "xy" === b.brushDirection || ("x" === b.brushDirection ? (d.y = g.top, e.y = g.bottom) : "y" === b.brushDirection && (d.x = g.left, e.x = g.right)), F.boundsPx = {
                xmin: d.x,
                xmax: e.x,
                ymin: d.y,
                ymax: e.y
            };
            var h = F.panel.scaleInv(d), i = F.panel.scaleInv(e);
            F.boundsData = c.findBox(h, i), F.boundsData = mapValues(F.boundsData, function (a) {
                return roundSignif(a, 14)
            }), E.data("bounds-data", F.boundsData), E.data("panel", F.panel)
        }

        function k(a) {
            if (void 0 === a) return F.boundsData;
            var b = {x: a.xmin, y: a.ymin}, c = {x: a.xmax, y: a.ymax}, d = F.panel.scale(b), e = F.panel.scale(c);
            j({xmin: Math.min(d.x, e.x), xmax: Math.max(d.x, e.x), ymin: Math.min(d.y, e.y), ymax: Math.max(d.y, e.y)})
        }
        ...
        function m() {
            E && E.remove(), E = $(document.createElement("div")).attr("id", D.id + "_brush").css({
            ...
            "xy" === b.brushDirection ? E.css({border: c}) : "x" === b.brushDirection ? E.css({
                "border-left": c,
                "border-right": c
            }) : "y" === b.brushDirection && E.css({"border-top": c, "border-bottom": c}), a.append(E), E.offset({
                x: 0,
                y: 0
        ...
        function o(a) {
            return void 0 === a ? F.down : void(F.down = a)
        }

        function p(a) {
            return void 0 === a ? F.up : void(F.up = a)
        }
        ...
        function r() {
            F.brushing = !0, m(), F.panel = c.getPanel(F.down, d), j(c.findBox(F.down, F.down)), n()
        }

        function s(a) {
            j(c.findBox(F.down, a)), E.show(), n()
        }

        function t() {
            F.brushing = !1, j(c.findBox(F.down, F.up))
        }
        ...
        function v() {
            F.dragging = !0, F.changeStartBounds = $.extend({}, F.boundsPx)
        }

        function w(a) {
            var d = a.x - F.down.x, e = a.y - F.down.y, f = F.changeStartBounds,
                g = {xmin: f.xmin + d, xmax: f.xmax + d, ymin: f.ymin + e, ymax: f.ymax + e};
            if (b.brushClip) {
                var h = F.panel.range, i = [g.xmin, g.xmax], k = [g.ymin, g.ymax];
                i = c.shiftToRange(i, h.left, h.right), k = c.shiftToRange(k, h.top, h.bottom), g = {
                    xmin: i[0],
                    xmax: i[1],
                    ymin: k[0],
                    ymax: k[1]
        ...
        function z() {
            F.resizing = !0, F.changeStartBounds = $.extend({}, F.boundsPx), F.resizeSides = i(F.down)
        }

        function A(a) {
            var b = a.x - F.down.x, d = a.y - F.down.y, e = $.extend({}, F.changeStartBounds), f = F.panel.range;
            F.resizeSides.left ? e.xmin = c.shiftToRange([e.xmin + b], f.left, e.xmax)[0] : F.resizeSides.right && (e.xmax = c.shiftToRange([e.xmax + b], e.xmin, f.right)[0]), F.resizeSides.top ? e.ymin = c.shiftToRange([e.ymin + d], f.top, e.ymax)[0] : F.resizeSides.bottom && (e.ymax = c.shiftToRange([e.ymax + d], e.ymin, f.bottom)[0]), j(e), n()
        }
        ...
        exports.onInputChange(a, null), imageOutputBinding.find(document).trigger("shiny-internal:brushed", {
            brushId: a,
            outputId: null
        })
    };
    ...
    exports.renderContent = function (a, b) {
        ...
        var f = a;
        if ("replace" === c) exports.initializeInputs(a), exports.bindAll(a); else {
            var g = $(a).parent();
    ...
    var htmlDependencies = {}, singletons = {
        knownSingletons: {},
        ...
        registerNames: function (a) {
            if ("string" == typeof a) this.knownSingletons[a] = !0; else if (a instanceof Array) for (var b = 0; b < a.length; b++) this.knownSingletons[a[b]] = !0
        },
        _addToHead: function (a) {
            if (a.length > 0) for (var b = $("<div>" + a + "</div>")[0], c = $("head"); b.hasChildNodes();) c.append(b.firstChild)
        },
    ...
    $.extend(datatableOutputBinding, {
        find: function (a) {
            ...
            if (_data && _data.colnames) {
                var colnames = $.makeArray(_data.colnames), header = $.map(colnames, function (a) {
                    return "<th>" + a + "</th>"
                }).join("");
                ...
                var searchCI = null === _data.options || "undefined" == typeof _data.options.search || _data.options.search.caseInsensitive !== !1,
                    oTable = $(el).children("table").DataTable($.extend({
                        ...
                        pageLength: 25,
                        ajax: {
                            url: _data.action, type: "POST", data: function (a) {
    ...
    (function () {
        ...
        }, this.receiveMessage = function (a, b) {
            throw"Not implemented"
    ...
    $.extend(textInputBinding, {
        find: function (a) {
            return $(a).find('input[type="text"], input[type="search"], input[type="url"], input[type="email"]')
        }, getId: function (a) {
            ...
            b.hasOwnProperty("value") && this.setValue(a, b.value), b.hasOwnProperty("label") && $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(b.label), b.hasOwnProperty("placeholder") && (a.placeholder = b.placeholder), $(a).trigger("change")
        }, getState: function (a) {
            return {
                label: $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(),
                value: a.value,
    ...
    $.extend(numberInputBinding, textInputBinding, {
        find: function (a) {
            ...
            b.hasOwnProperty("value") && (a.value = b.value), b.hasOwnProperty("min") && (a.min = b.min), b.hasOwnProperty("max") && (a.max = b.max), b.hasOwnProperty("step") && (a.step = b.step), b.hasOwnProperty("label") && $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(b.label), $(a).trigger("change")
        }, getState: function (a) {
            return {
                label: $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(),
    ...
    $.extend(checkboxInputBinding, {
        find: function (a) {
            ...
            return {label: $(a).parent().find("span").text(), value: a.checked}
        }, receiveMessage: function (a, b) {
    ...
    $.extend(sliderInputBinding, textInputBinding, {
        find: function (a) {
            ...
            var b, c = $(a), d = $(a).data("ionRangeSlider").result, e = c.data("data-type");
            ...
            var c = $(a), d = c.data("ionRangeSlider");
            c.data("immediate", !0);
            try {
                2 === this._numValues(a) && b instanceof Array ? d.update({
                    from: b[0],
                    to: b[1]
                }) : d.update({from: b}), forceIonSliderUpdate(d)
            } finally {
                c.data("immediate", !1)
            }
        }, subscribe: function (a, b) {
            ...
            var c = $(a), d = c.data("ionRangeSlider"), e = {};
            b.hasOwnProperty("value") && (2 === this._numValues(a) && b.value instanceof Array ? (e.from = b.value[0], e.to = b.value[1]) : e.from = b.value), b.hasOwnProperty("min") && (e.min = b.min), b.hasOwnProperty("max") && (e.max = b.max), b.hasOwnProperty("step") && (e.step = b.step), b.hasOwnProperty("label") && c.parent().find('label[for="' + $escape(a.id) + '"]').text(b.label), c.data("immediate", !0);
            try {
            ...
            var b, c = {}, d = $(a), e = d.data("data-type"), f = d.data("time-format");
            if ("date" === e) b = strftime.utc(), c.prettify = function (a) {
                return b(f, new Date(a))
            }; else if ("datetime" === e) {
                var g = d.data("timezone");
                b = g ? strftime.timezone(g) : strftime, c.prettify = function (a) {
                    return b(f, new Date(a))
                }
            }
            d.ionRangeSlider(c)
        ...
        a.preventDefault();
        var b = $(this), c = $("#" + $escape(b.attr("data-target-id"))), d = "Play", e = "Pause",
            f = void 0 !== b.attr("data-loop") && !/^\s*false\s*$/i.test(b.attr("data-loop")),
            g = b.attr("data-interval");
        if (g = isNaN(g) ? 1500 : +g, c.data("animTimer")) clearTimeout(c.data("animTimer")), c.removeData("animTimer"), b.attr("title", d), b.removeClass("playing"), c.removeData("animating"); else {
            var h, i;
    ...
    $.extend(dateInputBinding, {
        find: function (a) {
            ...
            var b = $(a), c = b.find("input"), d = c.data("datepicker").startDate, e = c.data("datepicker").endDate;
            ...
            return 2 === f ? f = "decade" : 1 === f ? f = "year" : 0 === f && (f = "month"), {
                label: b.find('label[for="' + $escape(a.id) + '"]').text(),
                value: this.getValue(a),
                valueString: c.val(),
                min: d,
                max: e,
            ...
            var c = $(a).find("input");
            b.hasOwnProperty("label") && $(a).find('label[for="' + $escape(a.id) + '"]').text(b.label), b.hasOwnProperty("min") && this._setMin(c[0], b.min), b.hasOwnProperty("max") && this._setMax(c[0], b.max), b.hasOwnProperty("value") && this.setValue(a, b.value), $(a).trigger("change")
        }, subscribe: function (a, b) {
            ...
            var b = $(a).find("input"), c = b.data("initial-date");
            ...
            if (void 0 !== b) if (null === b) $(a).bsDatepicker("setStartDate", null); else if (b = this._newDate(b), b = this._UTCDateAsLocal(b), !isNaN(b)) {
                var c = $(a).bsDatepicker("getUTCDate");
                $(a).bsDatepicker("setStartDate", b), $(a).bsDatepicker("setUTCDate", c)
            }
        }, _setMax: function (a, b) {
            if (void 0 !== b) if (null === b) $(a).bsDatepicker("setEndDate", null); else if (b = this._newDate(b), b = this._UTCDateAsLocal(b), !isNaN(b)) {
                var c = $(a).bsDatepicker("getUTCDate");
                $(a).bsDatepicker("setEndDate", b), $(a).bsDatepicker("setUTCDate", c)
            }
        }, _newDate: function (a) {
    ...
    $.extend(dateRangeInputBinding, dateInputBinding, {
        find: function (a) {
            ...
            var b = $(a).find("input"), c = b.eq(0).bsDatepicker("getUTCDate"), d = b.eq(1).bsDatepicker("getUTCDate");
            return [formatDateUTC(c), formatDateUTC(d)]
        }, setValue: function (a, b) {
            if (b instanceof Object) {
                var c = $(a).find("input");
                if (void 0 !== b.start) if (null === b.start) c.eq(0).val("").bsDatepicker("update"); else {
                    var d = this._newDate(b.start);
                    c.eq(0).bsDatepicker("setUTCDate", d)
                }
                if (void 0 !== b.end) if (null === b.end) c.eq(1).val("").bsDatepicker("update"); else {
                    var e = this._newDate(b.end);
                    c.eq(1).bsDatepicker("setUTCDate", e)
                }
            }
        }, getState: function (a) {
            var b = $(a), c = b.find("input"), d = c.eq(0), e = c.eq(1), f = d.bsDatepicker("getStartDate"),
            ...
            var c = $(a), d = c.find("input"), e = d.eq(0), f = d.eq(1);
            b.hasOwnProperty("label") && c.find('label[for="' + $escape(a.id) + '"]').text(b.label), b.hasOwnProperty("min") && (this._setMin(e[0], b.min), this._setMin(f[0], b.min)), b.hasOwnProperty("max") && (this._setMax(e[0], b.max), this._setMax(f[0], b.max)), b.hasOwnProperty("value") && this.setValue(a, b.value), c.trigger("change")
        }, initialize: function (a) {
            var b = $(a), c = b.find("input"), d = c.eq(0), e = c.eq(1), f = d.data("initial-date"),
    ...
    $.extend(selectInputBinding, {
        find: function (a) {
            ...
            "undefined" != typeof c ? c.setValue(b) : $(a).val(b)
        }, getState: function (a) {
            for (var b = new Array(a.length), c = 0; c < a.length; c++) b[c] = {value: a[c].value, label: a[c].label};
            return {
                label: $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(),
                value: this.getValue(a),
                options: b
            ...
            if (b.hasOwnProperty("options") && (c = this._selectize(a), c && c.destroy(), d.empty().append(b.options), this._selectize(a)), b.hasOwnProperty("config") && (d.parent().find('script[data-for="' + $escape(a.id) + '"]').replaceWith(b.config), this._selectize(a, !0)), b.hasOwnProperty("url")) {
                ...
                c.settings.load = function (d, g) {
                    ...
                    $.ajax({
                        ...
                        success: function (c) {
                            g(c), !f && b.hasOwnProperty("value") && e.setValue(a, b.value), f = !0
                        }
                    })
                }, c.load(function (a) {
            ...
            b.hasOwnProperty("label") && $(a).parent().parent().find('label[for="' + $escape(a.id) + '"]').text(b.label), $(a).trigger("change")
        }, subscribe: function (a, b) {
            $(a).on("change.selectInputBinding", function (a) {
                b()
            })
        }, unsubscribe: function (a) {
            ...
            if ($.fn.selectize) {
                var $el = $(el), config = $el.parent().find('script[data-for="' + $escape(el.id) + '"]');
                if (0 !== config.length) {
                    var options = $.extend({
                        labelField: "label",
                        valueField: "value",
                    ...
                    "undefined" != typeof config.data("nonempty") && (options = $.extend(options, {
                    ...
                    })), config.data("eval") instanceof Array && $.each(config.data("eval"), function (i, x) {
    ...
    $.extend(radioInputBinding, {
        find: function (a) {
            ...
            var c = $(a);
            b.hasOwnProperty("options") && (c.find("div.shiny-options-group").remove(), c.find("label.radio").remove(), c.append(b.options)), b.hasOwnProperty("value") && this.setValue(a, b.value), b.hasOwnProperty("label") && $(a).parent().find('label[for="' + $escape(a.id) + '"]').text(b.label), $(a).trigger("change")
        }, subscribe: function (a, b) {
    ...
    $.extend(checkboxGroupInputBinding, {
        find: function (a) {
            ...
            if ($('input:checkbox[name="' + $escape(a.id) + '"]').prop("checked", !1), b instanceof Array) for (var c = 0; c < b.length; c++) $('input:checkbox[name="' + $escape(a.id) + '"][value="' + $escape(b[c]) + '"]').prop("checked", !0); else $('input:checkbox[name="' + $escape(a.id) + '"][value="' + $escape(b) + '"]').prop("checked", !0)
        }, getState: function (a) {
            for (var b = $('input:checkbox[name="' + $escape(a.id) + '"]'), c = new Array(b.length), d = 0; d < c.length; d++) c[d] = {
                value: b[d].value,
                label: this._getLabel(b[d])
            };
            return {label: $(a).find('label[for="' + $escape(a.id) + '"]').text(), value: this.getValue(a), options: c}
        }, receiveMessage: function (a, b) {
            var c = $(a);
            b.hasOwnProperty("options") && (c.find("div.shiny-options-group").remove(), c.find("label.checkbox").remove(), c.append(b.options)), b.hasOwnProperty("value") && this.setValue(a, b.value), b.hasOwnProperty("label") && c.find('label[for="' + $escape(a.id) + '"]').text(b.label), $(a).trigger("change")
        }, subscribe: function (a, b) {
    ...
    $.extend(actionButtonInputBinding, {
        find: function (a) {
            ...
            $(a).on("click.actionButtonInputBinding", function (a) {
                var c = $(this), d = c.data("val") || 0;
                c.data("val", d + 1), b()
            })
        }, getState: function (a) {
            return {value: this.getValue(a)}
        }, receiveMessage: function (a, b) {
            var c = $(a), d = c.text(), e = "";
    ...
    (function () {
        this.beginUpload = function () {
            var a = this, b = "shinyupload_iframe_" + this.id;
            this.iframe = document.createElement("iframe"), this.iframe.id = b, this.iframe.name = b, this.iframe.setAttribute("style", "position: fixed; top: 0; left: 0; width: 0; height: 0; border: none"), $("body").append(this.iframe);
            var c = function () {
                a.shinyapp.makeRequest("uploadieFinish", [], function () {
                }, function () {
                }), $(a.iframe).remove(), $(a.fileEl).val("")
            };
    ...
    $.extend(FileUploader.prototype, FileProcessor.prototype), function () {
        this.makeRequest = function (a, b, c, d, e) {
            ...
            this.onProgress(a, 0), $.ajax(this.uploadUrl, {
                type: "POST", cache: !1, xhr: function () {
                ...
                }, data: a, contentType: "application/octet-stream", processData: !1, success: function () {
            ...
            var a = this, b = $.map(this.files, function (a, b) {
                return {name: a.name, size: a.size, type: a.type}
    ...
    var $fileInputs = $(), fileInputBinding = new InputBinding;
    $.extend(fileInputBinding, {
        ...
        getValue: function (a) {
            ...
            if (b) {
                ...
                var d = $(a).closest("div.form-group").find(".progress"), e = d.find(".progress-bar");
        ...
        _enableDraghover: function (a) {
            ...
            a.on("dragenter.dragHover", function (d) {
                0 === c.size() && a.trigger("draghoverstart" + b, d.originalEvent), c = c.add(d.originalEvent.target)
            }), a.on("dragleave.dragHover drop.dragHover", function (d) {
                c = c.not(d.originalEvent.target), 0 === c.size() && a.trigger("draghoverend" + b, d.originalEvent)
            })
        },
        ...
        _enableDocumentEvents: function () {
            var a = $("html");
            this._enableDraghover(a), a.on({
                "draghoverstart.fileDrag": function (a) {
                    $fileInputs.trigger("showZone.fileDrag")
                }, "draghoverend.fileDrag": function (a) {
                    $fileInputs.trigger("hideZone.fileDrag")
                }, "dragover.fileDrag drop.fileDrag": function (a) {
                    a.preventDefault()
                }
            })
        },
        _disableDocumentEvents: function () {
            var a = $("html");
            a.off(".fileDrag"), this._disableDraghover(a)
        },
        ...
        _handleDrop: function (a, b) {
            var c = a.originalEvent.dataTransfer.files, d = $(b);
            void 0 === c || null === c ? console.log("Dropping files is not supported on this browser. (no FileList)") : this._canSetFiles(c) ? (d.val(""), b.files = a.originalEvent.dataTransfer.files) : (d.val(""), uploadDroppedFilesIE10Plus(b, c))
        },
        ...
        subscribe: function (a, b) {
            ...
            this._isIE9() || !function () {
                var b = c._getZone(a), e = function () {
                    return d.data("state")
                }, f = function (a) {
                    return d.data("state", a)
                }, g = multimethod().dispatch(function (a) {
                    return [e(), a.type]
                }).when(["plain", "showZone"], function (a) {
                    b.removeClass(c._overClass), b.addClass(c._activeClass), f("activated")
                }).when(["activated", "hideZone"], function (a) {
                    b.removeClass(c._overClass), b.removeClass(c._activeClass), f("plain")
                }).when(["activated", "draghoverstart"], function (a) {
                    b.addClass(c._overClass), b.removeClass(c._activeClass), f("over")
                }).when(["over", "drop"], function (b) {
                    c._handleDrop(b, a)
                }).when(["over", "draghoverend"], function (a) {
                    b.removeClass(c._overClass), b.addClass(c._activeClass), f("activated")
                }).when(["plain", "draghoverstart"], function (a) {
                    window.setTimeout(function () {
                        b.addClass(c._overClass), b.removeClass(c._activeClass), f("over")
                    }, 0)
                })["else"](function (a) {
                    console.log("fileInput DnD unhandled transition", e(), a.type, a)
                });
                0 === $fileInputs.length && c._enableDocumentEvents(), f("plain"), b.on(c._zoneEvents, g), $fileInputs = $fileInputs.add(a), c._enableDraghover(b, ".zone")
            }(), d.on("change.fileInputBinding", uploadFiles)
        },
        unsubscribe: function (a) {
            var b = $(a), c = this._getZone(a);
            b.removeData("state"), c.removeClass(this._overClass), c.removeClass(this._activeClass), this._disableDraghover(c), b.off(".fileInputBinding"), c.off(this._zoneEvents), $fileInputs = $fileInputs.not(a), 0 === $fileInputs.length && this._disableDocumentEvents()
        }
